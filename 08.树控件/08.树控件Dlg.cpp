...
CMy08树控件Dlg::CMy08树控件Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MY08_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMy08树控件Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_TREE1, m_tree);
}

BEGIN_MESSAGE_MAP(CMy08树控件Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
BOOL CMy08树控件Dlg::OnInitDialog()
{
	...
	//2、设置节点
	HTREEITEM root = m_tree.InsertItem(TEXT("根节点"), 0, 0, NULL);//根节点没有父节点
...
void CMy08树控件Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMy08树控件Dlg::OnQueryDragIcon()
{
